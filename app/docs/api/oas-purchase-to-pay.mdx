---
title: OAS Purchase to Pay
hide_table_of_contents: true
---

:::caution PUBLIC CONSULTATION
This API specification and the JSON Schemas referenced herein are under **public consultation**.

Feedback and suggestions are welcome to help refine and finalize these documents.
:::
